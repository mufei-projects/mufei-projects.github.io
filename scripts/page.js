...
let gwhGame, gwhStatus, gwhScore, gwhLoading, gwhSettingsBtn, gwhSettingsPanel,gwhCandyCounter,gwhBeadsCounter,
    gwhThrowingFrequency,gwhSaveSettings, gwhDiscardSettings, gwhPauseGame;
...
$(document).ready( function() {
  ...
  //gwhThrowingFrequency.focusout( function(){
    //let input = parseFloat(gwhThrowingFrequency.val());
    //if(input<100){
      //alert('Frequency must be a number greater than or equal to 100');
      //gwhThrowingFrequency.val('');
    //}
  //})
